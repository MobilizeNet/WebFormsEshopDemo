...
#line hidden
        ...
        protected override System.Collections.Generic.IEnumerable<string> _Mobilize_GetChanges()
        {
            ...
            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_productToDelete) > 0)
            {
                yield return "productToDelete";
            }
            ...
            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_btnDelete) > 0)
            {
        ...
        protected override bool _Mobilize_HasChanges(string propertyName)
        {
            switch (propertyName)
            {
                case "productToDelete":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_productToDelete) > 0;
                case "CatalogService":
                ...
                case "btnDelete":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_btnDelete) > 0;
            }
        ...
        protected override Mobilize.WebMap.Common.Core.ReferenceMap _Mobilize_GetReferenceMap(Mobilize.WebMap.Common.Core.ReferenceMap refs)
        {
            ...
            refs["productToDelete"] = _Mobilize_References[0];
            ...
            refs["btnDelete"] = _Mobilize_References[12];
            return refs;
        }
        ...
        protected override System.Collections.Generic.IEnumerable<Mobilize.WebMap.Common.Core.IObservable> _Mobilize_GetReferences()
        {
            ...
            var ref_productToDelete = (Mobilize.WebMap.Common.Core.IObservable)this.productToDelete;
            if (ref_productToDelete != null)
                yield return ref_productToDelete;
            ...
            var ref_btnDelete = (Mobilize.WebMap.Common.Core.IObservable)this.btnDelete;
            if (ref_btnDelete != null)
                yield return ref_btnDelete;
            yield break;
        }

        private uint _Mobilize_DirtyFlag_0;
        private uint _Mobilize_LoadedFlag_0;
        const uint _Mobilize_Dirty_productToDelete = (uint)1 << 0;
        const uint _Mobilize_Loaded_productToDelete = (uint)1 << 0;
        ...
        const uint _Mobilize_Dirty_btnDelete = (uint)1 << 12;
        const uint _Mobilize_Loaded_btnDelete = (uint)1 << 12;
#line 11
    }
}