...
{
    public partial class CatalogService : Mobilize.WebMap.Common.Core.IObservable, Mobilize.WebMap.Common.Core.IDelta
    {
#line hidden
        ...
        {
            refs["db"] = _Mobilize_References[0];
            return refs;
        }
        ...
        {
            var ref_db = (Mobilize.WebMap.Common.Core.IObservable)this.db;
            if (ref_db != null)
                yield return ref_db;
            yield break;
        }
        ...
        {
            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_db) > 0)
            {
                yield return "db";
            }
        ...
        protected virtual bool _Mobilize_HasChanges(string propertyName)
        {
            ...
            {
                case "db":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_db) > 0;
            }
        ...
        const uint _Mobilize_Dirty_db = (uint)1 << 0;
        const uint _Mobilize_Loaded_db = (uint)1 << 0;
#line 13
    }
}