...
namespace WebSite
{
    ...
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<Mobilize.WebMap.Common.Server.ISortingActionService>(new Mobilize.Web.UI.Services.WebActionSortingService());
        }
        ...
        private static void AddDesktopCompatibilityPlatform(IServiceCollection services, EntryPoint entryPoint)
        {
            ...
            services.AddScoped<IApplication>((provider) => new ExtApplication(provider) { EntryPoint = entryPoint, AppName = "eShopLegacyWebForms" });
