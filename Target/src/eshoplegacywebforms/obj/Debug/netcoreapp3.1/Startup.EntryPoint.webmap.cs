...
namespace WebSite
{
    ...
    public partial class Startup
    {
        ...
        {
            config[Mobilize.Web.UI.GlobalKeys.DefaultPageTypeKey] = typeof(eShopLegacyWebForms.LogIn).FullName;
            new eShopLegacyWebForms.LogIn().Show();
        }
